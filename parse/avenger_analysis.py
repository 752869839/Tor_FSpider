...
class Analysis(object):
    def exquisite(self):
        search_query = {
            "query": {
                "match_phrase": {
                    "domain": {
                        "query": "avengerssbkfrkhlbpxmonvdvsyi3xesvzar2oxincbqx5rqoehpkwqd.onion"
                    }
                }
            }
        }

        res = scan(client=es, query=search_query, scroll='5m', index='page', doc_type='_doc', timeout='50m')
        cnt = 0
        for record in res:
            ...
            try:
                # user
                if record["_source"]["url"][0:75] == 'http://avengerssbkfrkhlbpxmonvdvsyi3xesvzar2oxincbqx5rqoehpkwqd.onion/user-':

                    spider_name = 'onion_avenger_bbs_spider'

                    domain = 'avengerssbkfrkhlbpxmonvdvsyi3xesvzar2oxincbqx5rqoehpkwqd.onion'
                    ...
                    try:
                        ...
                        user_img_url = 'http://avengerssbkfrkhlbpxmonvdvsyi3xesvzar2oxincbqx5rqoehpkwqd.onion' + user_img_url
                    except:
                        user_img_url = ''
                ...
                # topic
                if record["_source"]["url"][0:76] == 'http://avengerssbkfrkhlbpxmonvdvsyi3xesvzar2oxincbqx5rqoehpkwqd.onion/thread' and len(response.xpath('//div[@id="posts"]/div')) > 1 and "This post has been deleted." not in html:
    ...
    def update(self):
        ...
        for record in res:
            ...
            html = record["_source"]["raw_text"]
            response = etree.HTML(html)
            if record["_source"]["url"][0:76] == 'http://avengerssbkfrkhlbpxmonvdvsyi3xesvzar2oxincbqx5rqoehpkwqd.onion/forum-':
                try:
                    ...
                    data = []
                    index_url = 'http://avengerssbkfrkhlbpxmonvdvsyi3xesvzar2oxincbqx5rqoehpkwqd.onion/'
