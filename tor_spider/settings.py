...
#scrapy_redis
DUPEFILTER_CLASS = "scrapy_redis_sentinel.dupefilter.RedisDupeFilter"  # 使用scrapy_redis 里的去重组件，不使用scrapy默认的去重方式
SCHEDULER = "scrapy_redis_sentinel.scheduler.Scheduler"  # 使用scrapy_redis 里的调度器组件，不使用默认的调度器
...
ITEM_PIPELINES = {
    'scrapy_redis_sentinel.pipelines.RedisPipeline': 100,
