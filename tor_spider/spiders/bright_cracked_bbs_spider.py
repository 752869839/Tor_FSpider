...
class DarkSpider(scrapy.Spider):
    name = 'bright_cracked_bbs_spider'
    ...
    def parse(self, response):
        logger.info('开始采集!!!')
        item = HtmlItem()
        list_urls = response.xpath('//div[@id="cat_3" or @id="cat_7"]//a[@class="largetext"]/@href|//div[@id="cat_3" or @id="cat_7"]//span[@class="subforum_row"]/span/a/@href').extract()
