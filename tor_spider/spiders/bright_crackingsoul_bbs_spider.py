...
class DarkSpider(scrapy.Spider):
    name = 'bright_crackingsoul_bbs_spider'
    # allowed_domains = ['crackingsoul.com/']
    start_urls = ['https://crackingsoul.com/']
    ...
    def parse(self, response):
        logger.info('开始采集!!!')
        item = HtmlItem()
        list_urls = response.xpath('//td[@class="trow1"]/strong/span/a/@href').extract()
